/* iptux
 * Copyright (C) 2008,2009 Jally <jallyx@163.com>
 * Copyright (C) 2009      ManPT <pentie@gmail.com>
 *
...
GtkWidget *HelpDialog::CreateAboutDialog()
{
	...
	gtk_about_dialog_set_email_hook(GtkAboutDialogActivateLinkFunc(DialogOpenEmail),
					NULL, NULL);
	gtk_about_dialog_set_url_hook(GtkAboutDialogActivateLinkFunc(DialogOpenUrl), NULL,
				      NULL);
